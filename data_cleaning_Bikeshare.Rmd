...
df <- df %>% select(id, bike_exact_latitude=latitude, bike_exact_longitude = longitude,bike_exact_next_lat = next_lat, bike_exact_lon=next_lon)
...
```
## Add geodata (names & geocoordinates of centroids) of LOR/LOR districts with main dataset:
```{r}
...
fwrite(df.merged,'data/bikes_preprocessed_with_LOR_and_districts_and_duration_and_distance_and_speed_and_exact_geo_and_districts.csv')
```
...
df <- fread('data/bikes_preprocessed_with_LOR_and_districts_and_duration_and_distance_and_speed_and_exact_geo_and_districts.csv')
...
fwrite(df,'data/bikes_preprocessed_with_LOR_and_districts_and_duration_and_distance_and_speed_and_exact_geo_and_districts_and_time_data.csv')
```
